...
#define PIB_VERSION_MINOR	4
#define PIB_VERSION_REVISION	4
#define PIB_DRIVER_VERSION 	"0.4.4"
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 15, 0) || (defined(RHEL_MAJOR) && (RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(6, 6)))
...
#define PIB_SEND_BUFFER_SIZE		(16 * 1024 * 1024)
#define PIB_RECV_BUFFER_SIZE		(16 * 1024 * 1024)
